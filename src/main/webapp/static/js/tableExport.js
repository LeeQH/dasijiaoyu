  ...
  $.fn.extend({
    tableExport: function (options) {
      var defaults = {
        ...
        escape:            false,
        excelFileFormat:   'xlshtml',     // xmlss = XML Spreadsheet 2003 file
											// format (XMLSS), xlshtml = Excel
											// 2000 html format
        excelRTL:          false,         // true = Set Excel option
											// 'DisplayRightToLeft'
        excelstyles:       [],            // e.g. ['border-bottom',
											// 'border-top', 'border-left',
											// 'border-right']
        exportHiddenCells: false,         // true = speed up export of large
											// tables with hidden cells (hidden
        ...
        jspdf: {
          orientation:  'p',
          unit:         'pt',
          format:       'a4',             // jspdf page format or 'bestfit'
											// for autmatic paper format
											// selection
          ...
          autotable: {
            styles: {
              ...
              rowHeight:   12,
              fontSize:    8,
              fillColor:   255,           // color value or 'inherit' to use
											// css background-color from html
											// table
              textColor:   50,            // color value or 'inherit' to use
											// css color from html table
              fontStyle:   'normal',      // normal, bold, italic, bolditalic
											// or 'inherit' to use css
											// font-weight and fonst-style from
											// html table
              overflow:    'ellipsize',   // visible, hidden, ellipsize or
											// linebreak
            ...
            tableExport: {
              doc:               null,    // jsPDF doc object. If set, an
											// already created doc will be used
											// to export to
        ...
        numbers: {
          ...
          output: {                       // set output: false to keep number
											// format in exported output
            decimalMark:        '.',
            thousandsSeparator: ','
          }
        },
        onCellData:        null,
        onCellHtmlData:    null,
        onIgnoreRow:       null,          // onIgnoreRow($tr, rowIndex):
											// function should return true to
											// not export a row
        onMsoNumberFormat: null,          // Excel 2000 html format only. See
											// readme.md for more information
											// about msonumberformat
        outputMode:        'file',        // 'file', 'string', 'base64' or
											// 'window' (experimental)
        pdfmake: {
          enabled: false,                 // true: use pdfmake instead of
											// jspdf and jspdf-autotable
											// (experimental)
          docDefinition: {
            pageOrientation: 'portrait',  // 'portrait' or 'landscape'
            defaultStyle: {
              font: 'Roboto'              // default is 'Roboto', for arabic
											// font set this option to 'Mirza'
											// and include mirza_fonts.js
            }
          },
          fonts: {}
        },
        tbodySelector:     'tr',
        tfootSelector:     'tr',          // set empty ('') to prevent export
											// of tfoot rows
        theadSelector:     'tr',
        tableName:         'Table',
        type:              'csv',         // 'csv', 'tsv', 'txt', 'sql',
											// 'json', 'xml', 'excel', 'doc',
											// 'png' or 'pdf'
        worksheetName:     ''
      };
      ...
      if ( defaults.type == 'csv' || defaults.type == 'tsv' || defaults.type == 'txt' ) {
        ...
        function csvString (cell, rowIndex, colIndex) {
          ...
          if ( cell !== null ) {
            ...
            if ( defaults.type == 'tsv' ) {
              ...
              // Takes a string and encapsulates it (by default in
				// double-quotes) if it
        ...
        if ( defaults.pdfmake.enabled === true ) {
          ...
          // When setting jspdf.format to 'bestfit' tableExport tries to
			// choose
          // the minimum required paper format and orientation in which the
			// table
          // (or tables in multitable mode) completely fits without column
			// adjustment
          ...
          // The jsPDF doc object is stored in
			// defaults.jspdf.autotable.tableExport,
          ...
          loadImages(teOptions, function () {
            $(el).filter(function () {
              ...
              // onTable: optional callback function for every matching table
				// that can be used
              // to modify the tableExport options or to skip the output of a
				// particular table
              ...
              defaults.jspdf.autotable.tableExport = null;  // avoid deep
															// recursion error
              ...
              if ( typeof atOptions.createdHeaderCell !== 'function' ) {
                ...
                atOptions.createdHeaderCell = function (cell, data) {
                  ...
                  // jsPDF AutoTable plugin v2.0.14 fix: each cell needs its
					// own styles object
                ...
                ForEachVisibleCell(this, 'td,th', rowIndex, $hrows.length + $rows.length,
                  function (cell, row, col) {
                    ...
                    if ( typeof teOptions.columns[colKey] === 'undefined' ) {
                      // jsPDF-Autotable needs columns. Thus define hidden
						// ones for tables without thead
                      obj = {
                        title: '',
                        key:   colKey,
                        style: {
              ...
              // jsPDF AutoTable that can be used to modify the AutoTable
				// options
              ...
              // from jsPDF AutoTable that can be used to modify the AutoTable
				// options
              if ( typeof teOptions.onAfterAutotable === 'function' )
                teOptions.onAfterAutotable($(this), atOptions);

              // set the start position for the next table (in case there is
				// one)
      ...
      /*
		 * function FindColObject (objects, colIndex, rowIndex) { var result =
		 * null; $.each(objects, function () { if ( this.rowIndex == rowIndex &&
		 * this.key == colIndex ) { result = this; return false; } }); return
		 * result; }
		 */
          ...
          if ( defaults.htmlContent === true ) {
            ...
            if ( cellFormat != '' ) {
              ...
              $.each(text.split("\u2060"), function (i, v) {
                if ( i > 0 )
                  result += "\n";
                result += $.trim(v).replace(/\u00AD/g, ""); // remove soft
															// hyphens
              });
      ...
      function getStyle (target, prop) {
        try {
          if ( window.getComputedStyle ) { // gecko and webkit
            prop = prop.replace(/([a-z])([A-Z])/, hyphenate);  // requires
																// hyphenated,
																// not camel
      ...
      function getUnitValue (parent, value, unit) {
        ...
        var temp              = document.createElement("div");  // create
																// temporary
																// element
